   ...
   <?php 
    ...
    /*$res = mysql_query("select *, (select name from tbl_user where user_id=tbl_post.user_id) as uname, (select cat_name from tbl_category where cat_id=tbl_post.cat_id) as catname from  tbl_post");*/
      $res = mysql_query("select * from tbl_suppliers where supp_name='".$_REQUEST['suppname']."'");
          ...
          mysql_query("insert into tbl_suppliers values ('".$_REQUEST['suppname']."','".$_REQUEST['con']."','".$_REQUEST['email_id']."','".$_REQUEST['pass']."','".$_REQUEST['gndr']."', '".$_REQUEST['add']."','".$file."','".$_REQUEST['v_charge']."','".date('Y-m-d')."'") or die(mysql_error());
