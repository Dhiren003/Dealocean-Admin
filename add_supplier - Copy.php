...
<?php
 ...
 {
 ?>
  <title>Update Supplier | Dealocean</title>
<?php } else { ?>
<title>Add Supplier | Dealocean</title>
<?php } ?>
  <!-- Favicons-->
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Supplier</h5>
                <ol class="breadcrumb">
                  <li><a href="dashboard.php">Dashboard</a>
                  </li>
                  <li><a href="view_supplier.php">Supplier</a>
                  </li>
          <?php
            if(isset($_REQUEST['update']))
          {
  ...
  if(isset($_REQUEST['update']))
  {
    ...
    while($r = mysql_fetch_array($res))
    {
      ...
      $suppcharges = $r['Delivery_Charges'];
        ...
        { ?>
        <h4 class="header2">Update Supplier</h4>
        <?php } else { ?>
                <h4 class="header2">Add Supplier</h4>
        <?php } ?>
                <div class="row">
                  <form class="col s12" method="post" enctype="multipart/form-data" id="form1">
                    <div class="row">
                      <div class="input-field col s6">
                        <input id="first_name" type="text" name="suppname" value="<?php  echo $suppname; ?>" data-bvalidator="alpha,minlength[10],required" data-bvalidator-msg="Please Enter valid  Name">
         ...
         <div class="input-field col s6">
          ...
          {?>
           ...
           <div class="input-field col s12">
                     ...
                     <!-- <div class="input-field col s6">
                        <input type="number" class="price" name="km_price" value="<?php //echo $helprice; ?>" data-bvalidator="number,required" data-bvalidator-msg="Please Enter valid price">
                        <label for="age">More than 10km price</label>
                      </div>
                    
                    </div>
                    <div class="row">
                      <div class="input-field col s12">
                        <textarea id="about" class="materialize-textarea" length="120" name="abt_helper" data-bvalidator="required" data-bvalidator-msg="Please Enter about the helper "><?php //echo $helabout; ?></textarea>
                        <label for="message">About Helper</label>
                      </div> -->
                      <div class="row">
                        <div class="input-field col s12">
            <?php 
            ...
            ?>
              ...
              <?php } else { ?>
              <button class="btn cyan waves-effect waves-light right" style="margin-left:1%" type="submit" name="txtsubmit">Submit </button>
              <?php } ?>
                      <?php 
   ...
   <?php 
    if(isset($_REQUEST['txtsubmit']))
    {
    /*$res = mysql_query("select *, (select name from tbl_user where user_id=tbl_post.user_id) as uname, (select cat_name from tbl_category where cat_id=tbl_post.cat_id) as catname from  tbl_post");*/
      $res = mysql_query("select * from tbl_suppliers where supp_name='".$_REQUEST['suppname']."'");
          if(mysql_num_rows($res)>0)
          {
            echo "This Supplier has Already Exits..";
          }
          else
          {
          ...
          mysql_query("insert into tbl_suppliers values (null, '".$_REQUEST['suppname']."','".$_REQUEST['con']."','".$_REQUEST['email_id']."','".$_REQUEST['pass']."','".$_REQUEST['gndr']."', '".$_REQUEST['add']."','".$file."','".$_REQUEST['v_charge']."','".date('Y-m-d')."'") or die(mysql_error());
          
          /*$id = mysql_insert_id();
          mysql_query("insert into tbl_notification values (null,'".$id."','".date('Y-m-d')."','yes')");
          for($i=0; $i<count($_REQUEST['catname']); $i++)
          {
          //mysql_query("insert into tbl_helper_cat values (null, '".$id."', '".$_REQUEST['catname']."')");
     ...
     <?php
        if(isset($_REQUEST['txtupdate']))
        {
          ...
          mysql_query("update tbl_suppliers set supp_name='".$_REQUEST['suppname']."',contact_no='".$_REQUEST['con']."',email='".$_REQUEST['email_id']."',shop_address='".$_REQUEST['add']."',suppliers_img='".$file1."',Delivery_Charges='".$_REQUEST['v_charge']."' where supp_id ='".$_REQUEST['update']."'") or die(mysql_error());
